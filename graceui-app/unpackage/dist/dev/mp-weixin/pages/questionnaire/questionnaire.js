  ...
  return _c("view", [
    ...
    _c(
      ...
      [
        _c(
          "form",
          { attrs: { eventid: "219db076-2" }, on: { submit: _vm.formSubmit } },
          [
            _c(
              "swiper",
              {
                ...
                attrs: { current: _vm.currentQN, eventid: "219db076-0" },
                on: { change: _vm.swiperChange }
              },
              _vm._l(_vm.qns, function(item, index) {
                return _c(
                  "swiper-item",
                  { key: index, attrs: { mpcomid: "219db076-2-" + index } },
                  [
                    _c(
                      "view",
                      {
