...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("graceLoading", {
        attrs: { loadingType: _vm.loadingType, mpcomid: "a2fc6ee4-0" }
      })
    ],
    1
  )
