    ...
    [
        ...
        _vm._l(_vm.tabs, function(tab, index) {
          return _c(
            "view",
            {
              ...
              attrs: { id: "tabTag-" + index, eventid: "0b6b2410-0-" + index },
      ...
      _c(
        "swiper",
        {
          ...
          attrs: { current: _vm.swiperCurrentIndex, eventid: "0b6b2410-2" },
          on: { change: _vm.swiperChange }
        },
        _vm._l(_vm.newsAll, function(news, newsIndex) {
          return _c(
            "swiper-item",
            { key: newsIndex, attrs: { mpcomid: "0b6b2410-1-" + newsIndex } },
            [
              _c(
                "scroll-view",
                {
