        ...
        [
          ...
          _c(
            ...
            _vm._l(_vm.swiperItems, function(item, index) {
              return _c(
                "swiper-item",
                { key: index, attrs: { mpcomid: "094db93a-1-" + index } },
                [
                  _c(
                    "navigator",
          ...
          _c(
            ...
            _vm._l(_vm.swiperItems, function(item, index) {
              return _c(
                "swiper-item",
                { key: index, attrs: { mpcomid: "094db93a-2-" + index } },
                [
                  _c(
                    "navigator",
                    { attrs: { url: item.path, "open-type": item.openType } },
