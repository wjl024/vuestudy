<template>
	<view>
		...
		<!-- grace filter start -->
		<!-- 以下为演示内容 -->
		<view class="grace-imgitems" style='margin-top:100upx;'>
			<view class="grace-items" v-for="(item, index) in forData" :key="index">
				<image src="../../static/imgs/imgbanner.png" mode="widthFix"></image>
