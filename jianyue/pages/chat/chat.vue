		...
		<view class="input-box" :class="showEmji" @touchmove.stop.prevent="discard">
			...
			<view class="textbox">
				...
				<view class="text-mode"  :class="isVoice?'hidden':''">
					<view class="box">
						<textarea auto-height="true" v-model="textMsg" style="height: 70upx;"/>
					</view>
	...
	export default {
		...
		methods:{
			...
			sendMsg(content,type){
				...
				lastid++;
				let msg = {id:lastid,uid:0,username:"王某某",face:"/static/100.jpg",time:nowDate.getHours()+":"+nowDate.getMinutes(),type:type,msg:content};
				this.screenMsg(msg);
				// 定时器模拟对方回复,三秒
				setTimeout(()=>{
