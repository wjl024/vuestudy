<template>
	<view class="goods-content">
		<swiper class="grace-swiper" autoplay="true" indicator-dots indicator-color="rgb(254,238,233)" indicator-active-color="#FD572B"
		 interval="3000">
		...
		<view>
			<scroll-view scroll-x="true" class="grace-tab-title1 grace-center" id="grace-tab-title" :scroll-into-view="titleShowId">
				<view v-for="(tab,index) in tabs" :key="index" :class="[tabCurrentIndex==index?'grace-tab-current':'grace-notcurrent']"
		...
		<view class="navbar">
			...
			<view :class="[show2?'bar-cart':'s-bar']" @tap="toAccount">
				...
				<view class="point" v-if="show2"></view>
			</view>
			<view class="s-bar">
				<image src="../../static/shop.png" style="width: 40upx;height: 40upx;"></image>
			...
			<view class="cu-dialog">
				<view class="buy-content">
					...
					<view class="buy-goods-info">
						...
						<image class="cancel-buy" src="../../static/cancel-circle.png" style="height: 40upx;width: 40upx;margin-left: 190upx;"
						 @tap="hideModal"></image>
					</view>
				</view>
				<view class="buy-number">
					<view class="count">
						购买数量:
						<view class="btn-box">
							<button style="width: 60upx;height:40upx;display: flex;justify-content: center;align-items: center;border: 1upx solid #EEEEEE;"
							 :disabled="number==1" @tap="substract">-</button>
							<view style="width: 60upx;height:40upx;display: flex;justify-content: center;align-items: center;border: 1upx solid #EEEEEE;">{{number}}</view>
							<button style="width: 60upx;height:40upx;display: flex;justify-content: center;align-items: center;border: 1upx solid #EEEEEE;"
							 @tap="plus">+</button>
						</view>
					</view>
