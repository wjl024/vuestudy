      ...
      _vm._l(_vm.orderbyList, function(target, index) {
        return _c(
          "view",
          {
            ...
            attrs: { eventid: "f58dff92-0-" + index },
            on: {
              tap: function($event) {
                _vm.select(index)
              }
        ...
        _vm._l(_vm.goodsList, function(goods, index) {
          return _c(
            "view",
            {
              key: goods.goods_id,
              staticClass: "product",
              attrs: { eventid: "f58dff92-1-" + index },
              on: {
                tap: function($event) {
                  _vm.toGoods(goods)
                }
