      ...
      _vm._l(_vm.orderbyList, function(target, index) {
        return _c(
          "view",
          {
            ...
            attrs: { eventid: "265c413e-0-" + index },
            on: {
              tap: function($event) {
                _vm.select(index)
              }
        ...
        _vm._l(_vm.goodsList, function(goods, index0) {
          return _c(
            "view",
            {
              key: goods.goods_id,
              staticClass: "product",
              attrs: { eventid: "265c413e-1-" + index0 },
              on: {
                tap: function($event) {
                  _vm.toGoods(goods)
                }
