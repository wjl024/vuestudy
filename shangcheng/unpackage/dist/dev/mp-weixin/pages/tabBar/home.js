        ...
        [
          _c(
            ...
            _vm._l(_vm.swiperList, function(swiper, index) {
              return _c(
                "swiper-item",
                { key: swiper.id, attrs: { mpcomid: "46354f47-0-" + index } },
                [
                  _c("image", {
                    attrs: { src: swiper.img, eventid: "46354f47-2-" + index },
                    on: {
                      tap: function($event) {
                        _vm.toSwiper(swiper)
                      }
      ...
      _vm._l(_vm.categoryList, function(row, index) {
        return _c(
          "view",
          {
            ...
            attrs: { eventid: "46354f47-4-" + index },
            on: {
              tap: function($event) {
                _vm.toCategory(row)
              }
        ...
        _vm._l(_vm.Promotion, function(row, index) {
          return _c(
            "view",
            {
              key: index,
              staticClass: "column",
              attrs: { eventid: "46354f47-5-" + index },
              on: {
                tap: function($event) {
                  _vm.toPromotion(row)
                }
        ...
        _vm._l(_vm.productList, function(product, index) {
          return _c(
            "view",
            {
              ...
              staticClass: "product",
              attrs: { eventid: "46354f47-6-" + index },
              on: {
                tap: function($event) {
                  _vm.toGoods(product)
                }
