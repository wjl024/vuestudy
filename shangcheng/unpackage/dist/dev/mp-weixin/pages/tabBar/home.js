        ...
        [
          _c(
            ...
            _vm._l(_vm.swiperList, function(swiper, index0) {
              return _c(
                "swiper-item",
                { key: swiper.id, attrs: { mpcomid: "59a41ddd-0-" + index0 } },
                [
                  _c("image", {
                    attrs: { src: swiper.img, eventid: "59a41ddd-2-" + index0 },
                    on: {
                      tap: function($event) {
                        _vm.toSwiper(swiper)
                      }
      ...
      _vm._l(_vm.categoryList, function(row, index) {
        return _c(
          "view",
          {
            ...
            attrs: { eventid: "59a41ddd-4-" + index },
            on: {
              tap: function($event) {
                _vm.toCategory(row)
              }
        ...
        _vm._l(_vm.Promotion, function(row, index) {
          return _c(
            "view",
            {
              key: index,
              staticClass: "column",
              attrs: { eventid: "59a41ddd-5-" + index },
              on: {
                tap: function($event) {
                  _vm.toPromotion(row)
                }
        ...
        _vm._l(_vm.productList, function(product, index1) {
          return _c(
            "view",
            {
              ...
              staticClass: "product",
              attrs: { eventid: "59a41ddd-6-" + index1 },
              on: {
                tap: function($event) {
                  _vm.toGoods(product)
                }
