          ...
          _vm._l(_vm.categoryList, function(category, index) {
            return _c(
              "view",
              {
                ...
                attrs: { eventid: "bdf8b934-2-" + index },
                on: {
                  tap: function($event) {
                  ...
                  _vm._l(category.list, function(box, i) {
                    return _c(
                      "view",
                      {
                        key: i,
                        staticClass: "box",
                        attrs: { eventid: "bdf8b934-3-" + index + "-" + i },
                        on: {
                          tap: function($event) {
                            _vm.toCategory(box)
                          }
