          ...
          _vm._l(_vm.categoryList, function(category, index) {
            return _c(
              "view",
              {
                ...
                attrs: { eventid: "a6c59208-2-" + index },
                on: {
                  tap: function($event) {
                  ...
                  _vm._l(category.list, function(box, i) {
                    return _c(
                      "view",
                      {
                        key: i,
                        staticClass: "box",
                        attrs: { eventid: "a6c59208-3-" + index + "-" + i },
                        on: {
                          tap: function($event) {
                            _vm.toCategory(box)
                          }
