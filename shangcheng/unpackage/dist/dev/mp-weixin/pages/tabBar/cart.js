        ...
        _vm._l(_vm.goodsList, function(row, index) {
          return _c("view", { key: index, staticClass: "row" }, [
            _c(
              ...
              {
                staticClass: "menu",
                attrs: { eventid: "59a1a41e-0-" + index },
                on: {
                  tap: function($event) {
            ...
            _c(
              "view",
              {
                ...
                attrs: { eventid: "59a1a41e-7-" + index },
                on: {
              ...
              [
                _c(
                  "view",
                  {
                    ...
                    attrs: { eventid: "59a1a41e-1-" + index },
                    on: {
                      tap: function($event) {
                        _vm.selected(index)
                      }
                ...
                _c(
                  "view",
                  {
                    ...
                    attrs: { eventid: "59a1a41e-6-" + index },
                    on: {
                      tap: function($event) {
                        _vm.toGoods(row)
                      }
                      ...
                      _c("view", { staticClass: "price-number" }, [
                        ...
                        _c("view", { staticClass: "number" }, [
                          _c(
                            ...
                            {
                              staticClass: "sub",
                              attrs: { eventid: "59a1a41e-2-" + index },
                              on: {
                                tap: function($event) {
                                  $event.stopPropagation()
                                  _vm.sub(index)
                          ...
                          _c(
                            ...
                            {
                              staticClass: "input",
                              attrs: { eventid: "59a1a41e-4-" + index },
                              on: {
                                tap: function($event) {
                                  $event.stopPropagation()
                                  _vm.discard($event)
                          ...
                          _c(
                            ...
                            {
                              staticClass: "add",
                              attrs: { eventid: "59a1a41e-5-" + index },
                              on: {
                                tap: function($event) {
                                  $event.stopPropagation()
                                  _vm.add(index)
