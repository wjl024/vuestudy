  ...
  return _c("view", [
      ...
      [
        ...
        _c("view", { staticClass: "icon-btn" }, [
          _c("view", {
            ...
            attrs: { eventid: "59aa14c9-0" },
            on: { tap: _vm.toMsg }
          }),
          _c("view", {
            staticClass: "icon setting",
            attrs: { eventid: "59aa14c9-1" },
    ...
    _c("view", { staticClass: "user" }, [
      _c("view", { staticClass: "left" }, [
        _c("image", {
          attrs: { src: _vm.user.face, eventid: "59aa14c9-2" },
          on: { tap: _vm.toSetting }
        })
      ]),
        ...
        _vm._l(_vm.orderList, function(row, index) {
          return _c(
            "view",
            {
              key: index,
              staticClass: "box",
              attrs: { eventid: "59aa14c9-6-" + index },
              on: {
                tap: function($event) {
