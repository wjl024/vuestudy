      ...
      _vm._l(_vm.chatList, function(chat, index) {
        return _c("view", { key: index, staticClass: "chat" }, [
          _c(
            ...
            {
              staticClass: "row",
              attrs: { eventid: "6e8b6aaa-0-" + index },
              on: {
                tap: function($event) {
                  _vm.toChat(chat)
                }
