      ...
      _vm._l(_vm.chatList, function(chat, index) {
        return _c("view", { key: index, staticClass: "chat" }, [
          _c(
            ...
            {
              staticClass: "row",
              attrs: { eventid: "23a4f440-0-" + index },
              on: {
                tap: function($event) {
                  _vm.toChat(chat)
                }
