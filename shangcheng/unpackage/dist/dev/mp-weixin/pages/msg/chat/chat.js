                        ...
                        row.type == "voice"
                          ? _c(
                              "view",
                              {
                                ...
                                attrs: { eventid: "66b5ada4-0-" + index },
                                on: {
                                  tap: function($event) {
                                    _vm.playVoice(row)
                                  }
                        ...
                        row.type == "img"
                          ? _c(
                              "view",
                              {
                                ...
                                attrs: { eventid: "66b5ada4-1-" + index },
                                on: {
                                  tap: function($event) {
                                    _vm.showPic(row)
                                  }
                      ...
                      _c("view", { staticClass: "right" }, [
                        ...
                        row.type == "voice"
                          ? _c(
                              "view",
                              {
                                staticClass: "bubble voice",
                                class: _vm.playMsgid == row.id ? "play" : "",
                                attrs: { eventid: "66b5ada4-2-" + index },
                                on: {
                                  tap: function($event) {
                                    _vm.playVoice(row)
                                  }
                        ...
                        row.type == "img"
                          ? _c(
                              ...
                              {
                                staticClass: "bubble img",
                                attrs: { eventid: "66b5ada4-3-" + index },
                                on: {
                                  tap: function($event) {
                                    _vm.showPic(row)
                                  }
      ...
      [
        _c(
          ...
          _vm._l(_vm.emojiList, function(page, pid) {
            return _c(
              "swiper-item",
              { key: pid, attrs: { mpcomid: "66b5ada4-2-" + pid } },
              _vm._l(page, function(em, eid) {
                return _c(
                  "view",
                  {
                    key: eid,
                    attrs: { eventid: "66b5ada4-5-" + pid + "-" + eid },
                    on: {
                      tap: function($event) {
                        _vm.addEmoji(em)
                      }
            ...
            [
              _c("view", { staticClass: "box" }, [
                _c("textarea", {
                  ...
                  attrs: { "auto-height": "true", eventid: "66b5ada4-9" },
